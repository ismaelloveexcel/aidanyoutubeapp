...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "bg-[hsl(220,25%,12%)] border border-[hsl(210,30%,20%)] rounded-2xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.3)] transition-all duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.4)] hover:border-[hsl(210,40%,28%)]",
      className
    )}
    {...props}
  />
